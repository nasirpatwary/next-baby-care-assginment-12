...
const SocialLogin = () => {
  ...
  const handleSocialLogin = async (provider) => {
    ...
    try {
      const {ok, error} = await signIn(provider, { 
        callbackUrl, 
        redirect: false 
      })
      ...
      toast.success(`please waiting for login ${provider}`, { id: toastId })
    }
  }
  ...
  return (
    <div className="space-y-4 mt-4">
      ...
      <button 
        ...
        className="btn bg-white w-full text-black border border-gray-300 hover:bg-gray-50 flex items-center justify-center gap-2 py-2 rounded-md"
      >
      ...
      <button 
        ...
        className="btn bg-black w-full text-white border border-black hover:bg-zinc-800 flex items-center justify-center gap-2 py-2 rounded-md"
      >
