...
const ServicesOverview = () => {
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto dark:text-gray-400 text-base-content/70">
  ...
  <div 
    key={index} 
    className="card bg-white dark:bg-slate-800 shadow-xl border border-gray-100 dark:border-slate-700 transition-all duration-300 hover:shadow-2xl hover:-translate-y-4 group"
  >
    <div className="card-body">
      <div className="flex justify-between items-start mb-4">
        <div className={`p-4 rounded-2xl transition-colors duration-300 ${service.color} dark:bg-opacity-20`}>
          {service.icon}
        </div>
        <div className="badge badge-outline badge-sm opacity-70 dark:text-gray-400 dark:border-gray-600">
          {service.badge}
        </div>
      </div>

      <h3 className="card-title text-2xl mb-2 text-gray-900 dark:text-white group-hover:text-primary transition-colors">
        {service.title}
      </h3>
      ...
      <div className="card-actions justify-end mt-auto">
        <button className="btn btn-primary btn-block shadow-md hover:shadow-primary/20 dark:shadow-none transition-all">
          Learn More
        </button>
      </div>
    </div>
